...
import { fimg1, fimg2, fimg3, fimg4, fimg5, fimg6, } from "../assets"
...
const Footer = () => {
  return (
    ...
    <div className="bg-black text-white pt-[30px] ">
      <div className="w-full h-60 flex items-center justify-evenly">
        ...
        <div className="flex flex-col gap-3">
          ...
          <div className="gap-y-10 text-[14px] font-[Poppins] space-y-3">
            ...
            <span className="flex gap-x-4"><PhoneIcon className="w-[19px]" /> +233 735 5916</span>
            <span className="flex gap-x-4"><EnvelopeIcon className="w-[19px]" /> eventpro@gmail.com</span>
            <span className="flex gap-x-4"><GlobeAltIcon className="w-[19px]" /> www.eventpro.com</span>
          </div>
